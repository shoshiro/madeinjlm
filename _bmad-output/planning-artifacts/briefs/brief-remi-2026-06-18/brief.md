...
At every meaningful milestone, the same pain repeats:

**The emotional moments are never captured.** A professional photographer gets the posed shots. But the spoken love — what a grandfather wishes for a newborn, what a mother wants her soldier to carry into the army, what a best friend remembers at a wedding — evaporates into the air. The culture has the ritual of the blessing; there's no tool to keep it.

**Guest memories scatter and die.** Photos live on 40 phones. WhatsApp compresses everything. Google Photos requires accounts that grandma doesn't have. The "please send me your photos" message gets ~40% response, dropping near zero after 48 hours. The candid, emotional moments are the ones that vanish.

**"What do I even say?"** When someone is handed a camera and asked to record a blessing, most freeze and mumble "mazel tov, we love you." The result is forgettable. There's no guidance, no structure, no one drawing the real feeling out of them.

**Nothing connects the events.** Each milestone is an isolated WhatsApp group, a separate album, a guestbook in a closet. There's no continuity — no way to watch a mother's blessing to her child at his birth, his first day of school, and his graduation, side by side.

**Most families just accept the loss.** The biggest competitor is doing nothing. The pain is real but diffuse; people don't search for a solution because they've never imagined one.
...
**Primary: The milestone host (parent/organizer).** Testable hypotheses, not assumptions:
- Parents who recently hosted a milestone experienced memory chaos and would have paid $29–$79 to solve it.
...
**Validation plan:** 10 interviews with parents from the founder's NYC network who hosted a milestone in the last 12 months. Ask: What did you wish you'd captured? What did you lose? What would you pay to have it back? Listen for hesitation, not enthusiasm.
...
- >50% of video blessings are 30+ seconds (proves the interview format produces depth)
- Host satisfaction: >80% say "I'd use this again at the next milestone"
- 5+ families seal content for a future milestone (validates the Thread)
- 3+ organic referrals

**Year 2 — Repeat and growth:**
- 10+ families return for a second milestone (longitudinal value proven)
- First sealed content unsealed at a real milestone
- First longitudinal montage delivered (same person across milestones)
...
**MVP — Out (deliberately deferred):**
- **Conversational AI interviewer + automated video editing** — this is the v2 "wow" feature (live AI voice Q&A, smart cuts, voice synthesis via ElevenLabs). Heavy build; the sequential flow delivers ~80% of the magic now.
- **Longitudinal montage auto-generation** — enabled by the structured storage, but the rendering/curation comes after MVP.
- In-browser video recording (unreliable on mobile)
- Thread merging at marriage (architecturally complex; long-term vision)
- Real-time event screen ("The Room")
- Physical printed keepsake book
- Native mobile apps
- Shiva/memorial use case (avoid Empathy's bereavement lane)
- Synagogue/B2B partnerships (wrong sales motion for a solo founder at 5 hrs/week)
- Annual subscription (doesn't match usage; revisit once repeat usage is proven)
...
**Why per-milestone, not subscription:** Milestones are infrequent (1–3/year). An annual subscription means paying for quiet months. Per-milestone matches the moment of value. Subscription can be introduced later as a family plan if repeat usage proves strong.
